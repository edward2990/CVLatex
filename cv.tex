...
\position{FrontEnd Developer, specialized in AngularJS at BlueOcean Technologies LTD.} % Your expertise/fields


\makecvfooter{\today}{Ing. Eduarluis Espinosa Gato}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
